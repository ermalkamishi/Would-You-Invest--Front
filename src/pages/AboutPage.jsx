...
/* ─── Section 5 · Mobile-Only Footer & Links ────────────────────────── */
function MobileFooterSection() {
  return (
    <section className="block md:hidden border-t border-white/10 bg-[hsl(240,12%,5%)]/95 px-5 pt-6 pb-6 relative overflow-hidden">
      {/* Top neon accent line */}
      <div className="absolute top-0 left-0 w-full h-[1px] bg-gradient-to-r from-transparent via-[#00FF66]/50 to-transparent" />

      {/* Brand logo & tagline */}
      <div className="flex flex-col items-center text-center mb-5">
        <NavLink to="/" className="flex items-center gap-2 mb-1.5">
          <div className="w-7 h-7 rounded-lg bg-[#00FF66]/20 flex items-center justify-center border border-[#00FF66]/40">
            <TrendingUp className="w-3.5 h-3.5 text-[#00FF66]" />
          </div>
          <span className="font-extrabold text-base tracking-tight text-white">CapTab</span>
        </NavLink>
        <p className="text-white/40 text-xs max-w-xs leading-relaxed">
          The pitch feed where ideas meet virtual capital. Swipe, invest, and discover signals early.
        </p>
      </div>

      {/* Social Media Icons */}
      <div className="flex flex-col items-center gap-2.5 mb-5">
        <p className="text-[10px] text-white/30 font-mono uppercase tracking-[0.2em]">Connect With Us</p>
        <div className="flex items-center gap-3">
          {[
            ...
            <button
              ...
              type="button"
              aria-label={label}
              className="w-10 h-10 rounded-xl flex items-center justify-center bg-white/5 border border-white/10 text-white/50 hover:text-[#00FF66] hover:border-[#00FF66]/40 hover:bg-[#00FF66]/10 active:scale-95 transition-all"
            >
              <Icon />
            </button>
          ))}
      ...
      <div className="flex items-center justify-center gap-6 py-3 border-y border-white/5 mb-5 text-xs">
        <NavLink
          to="/terms"
          className="text-white/50 hover:text-[#00FF66] font-medium transition-colors"
        >
          Terms of Service
        </NavLink>
      ...
      <div className="text-center text-[10px] text-white/25">
        <p>© {new Date().getFullYear()} CapTab. All rights reserved.</p>
      </div>
    </section>
  );
}
